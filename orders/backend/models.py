...
class ImportLog(models.Model):
    ...
    supplier = models.ForeignKey(Shop, verbose_name='Поставщик', related_name='import_logs', on_delete=models.CASCADE)
    ...
    errors = models.TextField(verbose_name='Ошибки', blank=True, null=True)
